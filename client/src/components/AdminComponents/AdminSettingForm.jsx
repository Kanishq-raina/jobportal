// components/AdminSettingForm.jsx
import React from "react";


const AdminSettingForm = ({ formData, onChange, onSubmit }) => {
  const glowBtn =
    "mt-4 w-full px-4 py-2 font-semibold rounded-xl bg-gradient-to-br from-blue-600 to-blue-800 text-white shadow-md hover:shadow-lg active:scale-95 transition-transform duration-300";
